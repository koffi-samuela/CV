        ...
        <section id="presentation" >
                <div class="aboutMe ">
                        ...
                        <div class="aboutMe__texte">
                            ...
                            <h2>PRESENTATION</h2>
                                <p>Passionnée par le développement web, j'ai approfondi mes compétences en me spécialisant dans la création d'applications au cours de mon parcours universitaire. Actuellement en recherche d'un stage de 3 mois en développement d'applications, je suis animée par le désir de mettre en œuvre mes compétences dans des projets informatiques stimulants, tout en nourrissant ma curiosité pour l'apprentissage continu des langages de programmation.</p>
                                <div class="mariocar"> 
